...
import com.hebat.sibat.sibat.ui.ui.potensi.PotensiAdapter
import kotlinx.android.synthetic.main.potensinagari.*
import org.json.JSONObject

class Potensinagari : AppCompatActivity() {
    ...
    inner class get_data_potensi : AsyncTask<String, Void, String>(){
        ...
        override fun onPreExecute() {
            super.onPreExecute()
            pd= ProgressDialog.show(this@Potensinagari,"","Wait",true,true)
        }
...
//                model.tanggal=data.getString("tanggal")
                ...
                rc.layoutManager= LinearLayoutManager(this@Potensinagari)
                rc.adapter=adapter
            }
