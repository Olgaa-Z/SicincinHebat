...
//        supportActionBar?.title =t
    ...
    inner class getdetaillayanan : AsyncTask<String, Void, String>(){
        ...
        override fun doInBackground(vararg params: String?): String {
            ...
            return request.sendGetRequest(Config.url_detail_layanan+id)
        ...
        override fun onPostExecute(result: String?) {
            ...
            if (objek.getInt("status")==1){
                ...
                for (i in 0 until array.length()) {
                    ...
                    judul.text = data.getString("nama_layanan")
                    isi.text = data.getString("isi_layanan")
//                    tanggal.text = data.getString("tanggal")
                    Glide.with(this@DetailLayanan)
                        .load(Config.url_gambar_layanan+ data.getString("gambar")).into(gambarberita)
                }
            }
        }
